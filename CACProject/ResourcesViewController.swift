...
class ResourcesViewController: UIViewController {
    ...
    func loadResources() {
        resources = [
            ...
            Resource(
                title: "BrillTutor",
                link: "https://www.brilltutor.com",
                overview: "AI-personalized SAT prep platform: Provides over 2,000 expert-verified SAT questions, adaptive full-length practice tests, instant hints, custom explanations, performance analytics, and a digital SAT environment modeling real test conditions. Designed to accelerate learning and simulate test day. Includes a free trial; ongoing access is paid. (Free Trial for 7 days then Paid)",
                isPaid: true
            ),
            Resource(
                title: "Whiz Study",
            ...
            Resource(
                ...
                overview: "Free SAT and PSAT practice platform with over 20 full-length practice exams, targeted practice by topic, performance analytics, and an AI tutor for step-by-step explanations. Upgrade to Whiz Pro unlocks personalized AI tutoring and digital AP exams. Mobile app available; all practice content is free, advanced features require payment.",
                isPaid: false
            ),
            Resource(
                title: "Quizlet",
                link: "https://quizlet.com/",
                overview: "A versatile study platform offering millions of user-generated flashcard sets, adaptive learning modes, interactive games, and AI-powered tutoring (Q-Chat). Covers almost every academic subject and test prep including SAT, ACT, AP exams. Available on web and mobile. Quizlet Plus subscription unlocks premium features like offline access, advanced content creation, and AI tutor support.",
                isPaid: false
            )
        ]
